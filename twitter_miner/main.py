...
TWIT_MINE_PATH = os.path.join(os.path.expanduser("~"), 'TwitMine')
if not os.path.exists(TWIT_MINE_PATH):
    os.mkdir(TWIT_MINE_PATH)
...
def process_user(username):
    ...
    log_file_target = search + "-" + today + ".log"
    log_file = os.path.join(TWIT_MINE_PATH, log_file_target)
